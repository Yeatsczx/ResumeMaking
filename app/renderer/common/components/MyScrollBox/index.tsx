...
function MyScrollBox({ children, maxHeight = 200, style = {}, innerStyle = {}, onScrollTop }: IProps) {
  ...
  return (
    <div className="scroll_box_outer" style={_style} onScroll={onScroll}>
      <div className="scroll_box_hidden" style={{ maxHeight: `${maxHeight}px` }}>
        <div className="scroll_box_inter" style={innerStyle}>
          {children}
        </div>
      </div>
    </div>
