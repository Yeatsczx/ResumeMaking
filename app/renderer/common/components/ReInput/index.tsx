...
class ReInput extends React.PureComponent<InputProps, InputState> {
  ...
  renderBefore() {
    ...
    return !!addonBefore && <div styleName="Re-input-center">{addonBefore}</div>;
  }

  renderAfter() {
    const { addonAfter } = this.props;
    return !!addonAfter && <div styleName="Re-input-center">{addonAfter}</div>;
  }
...
export default CSSModules(ReInput, styles, { allowMultiple: true });
